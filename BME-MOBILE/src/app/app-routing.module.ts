...
const routes: Routes = [
  ...
  {
    path: 'batchtransfer',
    loadChildren: () => import('./batchtransfer/batchtransfer.module').then( m => m.BatchtransferPageModule),
    canActivate: [AuthGuard],
  },
  ...
  },
  {
    ...
    loadChildren: () => import('./inventory-validation/inventory-validation.module').then( m => m.InventoryValidationPageModule),
    canActivate: [AuthGuard],
  },
  {
    path: 'inventory-count-search',
    canActivate: [AuthGuard],
    loadChildren: () => import('./modal/inventory-count-search/inventory-count-search.module').then( m => m.InventoryCountSearchPageModule)
  },
   {
    path: 'bulkrmvalidation',
    canActivate: [AuthGuard],
    loadChildren: () => import('./bulkrmvalidation/bulkrmvalidation.module').then( m => m.BulkrmvalidationPageModule)
  },
