...
function lotbarcode(mm=''){
        ...
        $('#PutAway_qty').val('');
        $('#ToBinNo').val('');
        $.post('putaway/findlot',{lot:mm},function(res){
...
function binbarcode(mm = ''){
    ...
    $.post('putaway/findBin',{BinNo:dd},function(res){
...
$("#btn-bin-search").click(function(){
    $.post('putaway/findBin',{BinNo:$(this).val()},function(res){
