			...
			<table class='table table-sm table-bordered ' style='width:70%;margin:0px auto;'>
				<tr>
					<td>Description</td><td colspan=3>
						...
						<input id='LocationKey' type='hidden'/>
					</td>
				</tr>
				<tr>
					<td>Lot No</td><td colspan=3><input id='lotno' type='text' class='form-control form-control-sm' style='background-color:#ffc10730'  readonly/></td>
				</tr>
				<tr>
