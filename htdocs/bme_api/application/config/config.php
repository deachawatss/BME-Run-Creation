...
|
*/
$config['base_url'] = "http://".$_SERVER['SERVER_NAME'].'/bme_api';
if( isset($_SERVER['HTTPS'] ) ) {
	$config['base_url'] = "https://".$_SERVER['SERVER_NAME'].'/bme_api';
}else{
	$config['base_url'] = "http://".$_SERVER['SERVER_NAME'].'/bme_api';
}

$config['appname']="bme_api";
$config['title']="Management System";
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
##EMAIL CONFIG###
$config['cemail']=array(
	"username"=>"NWFTHSRM@yahoo.com",
	"password"=>"eaxjuflkffnledjj",
...
##EMAIL CONFIG###
$config['cpr_email']=array(
	"username"=>"nwfthcpr@gmail.com",
	"password"=>"AriPos.100",
...
##EMAIL CONFIG###
$config['rmr_email']=array(
	"username"=>"RMR.NWFP@gmail.com",
	"password"=>"Maint.0519",
	"smtp_host"=>"ssl://smtp.googlemail.com",
	"smtp_port"=>"465",
	"smtp_crypto"=>"tls",
