$(".btn-add-cust_bulkrun").off("click");

var dta;
var dtax;
var mydata = [];
$(document).off('click','.btn-edit-cust_bulkrun')


$(document).on("click",".btn-add-cust_bulkrun",function(){
    mydata = [];
...
$(document).on('click','#btn-search',function(){
    ...
    $.post('CreateRunBulk/getBatchList',mparam,function(res){
        var dbox = bootbox.dialog({
            title : 'Create Run',
            size : 'lg',
            message : `
...
$(document).on("click",".btn-edit-cust_bulkrun",function(){
    var vdata=$(this).data('id');

    $.post('CreateRunBulk/getRunInfo',{id:vdata},function(xres){
            ...
            buttons : {
                Submit: {
                    ...
                    callback: function(){
                        ...
                        formData.append('runno', xres.runhdr.runno); // RunNo is now numeric
